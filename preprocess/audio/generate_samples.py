...
if __name__ == '__main__':
    ...
    for window_size in range(1,5):
        ...
        main(1, window_size, 20, vad_dict, 1)
        ...
        main(2, window_size, 20, vad_dict, 1)

        # experiment 3 done
        main(3, window_size, 20, vad_dict, 1, 'all_unsuccessful') # start/continue/all_unsuccessful

        # experiment 4 done
        main(4, window_size, 20, vad_dict, 1, 'start')

        # experiment 5  done
        main(5, window_size, 20, vad_dict, 1, 'continue')
