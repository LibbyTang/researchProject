...
pose_path2 = "../data/cam2_final.pkl"
pose_path3 = "../data/cam3_final.pkl"
...
def make_all_examples(Num, windowSize, feature_fs, numberOfExperiment=None, category=None):
    ...
    if Num == 1:
        ...
        maker = utils.Maker(tracks_path2= pose_path2, tracks_path3= pose_path3, accel_path=accel_path, all_sample_path=temp)
        ...
        maker = utils.Maker(tracks_path2= pose_path2, tracks_path3= pose_path3, accel_path=accel_path, vad_path=temp)
        for index in range(0, numberOfExperiment):
            print("num : 2 -- ", index)
        ...
        maker = utils.Maker(tracks_path2= pose_path2, tracks_path3= pose_path3, accel_path=accel_path, unsuccessful_vad_path=temp)
        for index in range(0, numberOfExperiment):
